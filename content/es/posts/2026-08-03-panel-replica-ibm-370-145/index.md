...
**Y de las dos, la que conviene bajar hoy es TK5.** No por preferencia estética: por mantenimiento. El sitio original de TK4- en `wotho.ethz.ch` está **caído** —no resuelve, así que no tiene sentido enlazarlo— y sobrevive por un mirror, **[wotho.pebble-beach.ch/tk4-](https://wotho.pebble-beach.ch/tk4-/)**, verificado el 2026-08-03. TK5, en cambio, sigue vivo: la versión en línea es **Update 5, fechada el 2026-02-18**, y está en **[prince-webdesign.nl/tk5](https://www.prince-webdesign.nl/tk5)**.[^tk5]

Que un proyecto siga actualizándose importa acá más de lo que parece. Un turnkey no es sólo el sistema operativo: trae también el Hercules con el que corre. TK5 se rearmó sobre TK3 y TK4 reduciendo el sistema a **15 volúmenes DASD**, y bajarlo es literalmente descomprimir un ZIP y ejecutar un script. El paquete son 475 MiB —`mvs-tk5.zip`, 498 312 872 bytes— y el servidor lo fecha el mismo 18 de febrero de 2026 que anuncia la página, así que lo que se baja es efectivamente la versión anunciada.[^tk5]

Para el procedimiento hay una guía en castellano que instala exactamente esto —TK5 más un Hercules compilado desde el fuente (SDL-Hercules-390) más `c3270` como terminal— sobre Ubuntu: **[«Cómo instalo MVS 3.8j en Ubuntu»](https://ubuntuperonista.blogspot.com/2024/06/como-instalo-mvs-3.8j-en-ubuntu.html)**, en el blog Ubuntu Peronista, julio de 2024. Es para x86 y no para la Pi, así que los pasos de compilación hay que rehacerlos en ARM64 — pero el recorrido es el mismo y ahorra la parte de averiguar cuál de las mil variantes de Hercules usar.

Y para todo lo demás que gira alrededor de esto, la lista curada de referencia es **[Awesome Mainframes](https://github.com/FuzzyMainframes/Awesome-Mainframes)**: emuladores, distribuciones turnkey, lenguajes, comunidades y tutoriales, en un solo índice.
...
Es una decisión de diseño que el proyecto **todavía no tiene tomada**, y no por falta de ganas sino porque depende de un número que no está medido: cuánta RAM ocupan realmente los volúmenes ya descomprimidos. De ese número sale todo lo demás — si entran o no en una Pi de 4 GB, si conviene poner todo en RAM o sólo los volúmenes de lectura y dejar los de escritura en almacenamiento persistente.

Un piso sí se conoce: los 475 MiB del ZIP de TK5. Los volúmenes descomprimidos no pueden pesar menos que eso, y aunque se expandieran cuatro veces seguirían entrando en una Pi 5 de 8 GB. Pero «seguirían entrando» no es una medición, y la diferencia entre 2 GB y 6 GB es exactamente la que decide si la Pi de 4 GB sirve.
...
[^tk5]: [MVS Turnkey 5](https://www.prince-webdesign.nl/tk5) — la página del proyecto se presenta como «MVS Turnkey 5 Update 5» con fecha «Update 2026/02/18», describe al sistema como «an implementation of OS/VS2 MVS Release 3.8J» y aclara que «TK5 is fully restructured but still based upon TK3, TK4 and TK4ROB», con 15 volúmenes DASD. Consultada el 2026-08-03.
