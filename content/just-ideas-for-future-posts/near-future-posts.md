...
- **J-10** — [Serie «Sicología sin humo de tabaco»](nerd/draft-sicologia-sin-humo-de-tabaco-segun-chatgpt.md) ✍️ **escrita 2026-08-02, sin publicar — un draft, tres posts.** Secuela de [«Soplar humo de tabaco»](/posts/soplar-humo-de-tabaco/). Se dividió por argumento (opción B) el 2026-08-02:
  ...
  3. **[…según Claude](/posts/sicologia-sin-humo-de-tabaco-segun-claude/)** — los mismos cuatro prompts a otro modelo, con su advertencia metodológica. 1.974 palabras, 13 footnotes. Hero listo (símbolo de Claude, CC0).

- **J-11** — [Construir el panel de control de un IBM System/370](/posts/panel-replica-ibm-370-145/) ✅ **publicado 2026-08-03.** La entrada se conserva porque el proyecto sigue abierto: hay seis secciones que el post declara sin resolver y que, cuando se resuelvan, dan material para una segunda parte. Réplica física del panel de operador de un 370/145: acrílico cortado a láser, un Arduino Mega que maneja 208 LEDs y lee 128 líneas de llaves, y una Raspberry Pi 5 corriendo Hercules con MVS 3.8j.
  - **Bundle del post:** `content/es/posts/2026-08-03-panel-replica-ibm-370-145/`. Adentro van los cuatro documentos de diseño del proyecto (`referencias/`), las hojas de datos de los componentes (`datasheets/`, ~11 MB) y el esquemático de KiCad de la unidad repetida con su generador (`kicad/`).
  - **Lo que está sostenido por los documentos:** la elección del /145 y su fundamento, el inventario completo de lámparas y llaves, delta-sigma a 1 kHz en vez de PWM, las cadenas TPIC6B595 y 74HC165, el protocolo con el host, la alimentación, y por qué MVS 3.8j quedó en dominio público.
  - **Seis ítems abiertos**, que el post declara en voz alta en vez de disimular: medir Hercules en la Pi 5 y pegar el `.cnf`, instalar MVS y tomar notas, decidir lo de los discos en RAM, el firmware del Arduino, el software de la Pi, y una **foto frontal de una consola física** — la del hero es un render 3D y no sirve para fijar proporciones.
  - **Decisiones tomadas al publicar:** se versionan los 11 MB de hojas de datos (la copia local vale contra el link rot, y el post lo dice explícitamente); el esquemático de KiCad pasa el ERC sin errores de cableado y el netlist confirma que cada LED tiene su red propia.
  - **Cruzar con [[J-08]]** — «IBM MVS, Hercules y los jobs JCL que escribí para sentir cómo era 1970» es el hermano temático: mismo emulador, mismo sistema operativo, otro ángulo. Cuando se escriba J-08, enlazarlos en los dos sentidos.
